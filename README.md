...
This version is intended for Linux. If you are on Windows, use WSL.

## Simple install steps for this build

1. Install the packages required for the current build.
...
## Optional packages for the legacy build

Only install these if you plan to build the legacy target with `make legacy`.
